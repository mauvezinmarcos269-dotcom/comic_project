...
def execute_local_module(
    ...
    if module == "publisher_share":
        ...
        return RouterResult(
            ...
            fig, evidence.head(10) if not evidence.empty else None, route,
        )
    ...
    if module == "marvel_dc":
        ...
        return RouterResult(
            ...
            fig, evidence if not evidence.empty else None, route,
        )
    ...
    if module == "pca_cluster":
        ...
        return RouterResult(
            ...
            fig, pca_df[display_cols].head(15), route,
        )
    ...
    if module == "regression":
        ...
        return RouterResult(
            ...
            None, reg_df[["Price", "Unit Sales", "Predicted_Sales"]].head(15), route,
        )
    ...
    if module == "decade_top10":
        ...
        return RouterResult(
            ans, fig,
            pd.DataFrame(list(ranking.items()), columns=["系列名称", "累计总销量"]),
            route,
        )
    ...
    if module == "generic_qa" or client is None:
        ...
        if client is None:
            # 修复：原代码 f-string 缺少 f 前缀，len(df) 不会被插值
